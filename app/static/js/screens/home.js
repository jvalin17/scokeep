...
/** Return the Create tab form HTML. */
function _renderCreateTab() {
    return `<form id="create-form" class="form visible">
...
/** Return the Join tab form HTML. */
function _renderJoinTab() {
    return `<form id="join-form" class="form hidden">
...
/** Return the Quick Game tab form HTML. */
function _renderQuickTab() {
    return `<div id="quick-form" class="form hidden">
...
/** Bind tab-switching listeners. Calls loadRecent / loadCachedRooms on tab activation. */
function _bindTabListeners(container, loadRecent, loadCachedRooms) {
...
/** Bind Create tab: add-player button + form submit. */
function _bindCreateTab(container, state, navigate) {
    let playerCount = 2;
...
/** Bind Join tab: recent rooms loader, browse panel, filters, forgot-PIN, form submit. */
function _bindJoinTab(container, state, navigate) {
    // Load recent playgrounds into the recent list
...
/** Bind Quick Game tab: room buttons, browse panel, PIN verify, add-player, start. */
function _bindQuickTab(container, navigate) {
    ...
    // Render clickable room buttons into a list element (used by both recent and browse lists)
...
export const homeScreen = {
    mount(container, state, { navigate }) {
        ...
        const { loadRecent } = _bindJoinTab(container, state, navigate);
