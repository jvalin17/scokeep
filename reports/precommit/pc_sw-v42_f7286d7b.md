<!-- agent-toolkit:precommit | v1 | 2026-08-20 | f7286d7b -->
<!-- writer: hooks/finalize_report.py — agent did not write this file -->
# Pre-commit Report: sw-v42
...
- App verification: na — SW bump to force cache bust after revert.

## Summary

Bump SW v36 to v42 — browsers still have v41 cached with broken code.
